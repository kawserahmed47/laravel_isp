          ...
          <div class="box box-info">
            ...
            <form method="post" action="{{url('/insertSlider')}}" enctype="multipart/form-data">
              ...
              <div class="input-group">
                ...
                <input type="text" required name="heading" class="form-control" placeholder="Slider Heading">
              </div>
              <br>
              ...
              <div class="input-group">
                ...
                <input type="text" required name="subheading" class="form-control" placeholder="Subheading">
              </div>
