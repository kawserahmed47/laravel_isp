      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
            <form method="post" action="{{url('/insertSupport')}}" enctype="multipart/form-data">
              @csrf
              ...
              <div class="input-group">
               ...
               <label for="">Mobile</label>
                <input type="number" required name="mobile" class="form-control" placeholder="Mobile">
              </div>
              <br>
